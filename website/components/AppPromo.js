...
export default function AppPromo() {
    return (
        <section className="relative py-24 overflow-hidden bg-gradient-to-br from-orange-700 to-orange-900">
            {/* Background Pattern */}
            ...
            <div className="container mx-auto px-4 sm:px-6 relative z-10">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
                    ...
                    >
                        ...
                        <p className="text-lg text-white/90 mb-8 leading-relaxed max-w-xl ml-auto">
                    ...
                    <motion.div
                        ...
                        className="lg:w-1/2 relative order-1 lg:order-2 flex justify-center lg:justify-start"
                    >
